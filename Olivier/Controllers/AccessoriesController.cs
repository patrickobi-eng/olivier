...
namespace Olivier.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public AccessoriesController(AccessoryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,BrandName,colour,IsNew")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BrandName,colour,IsNew")] Accessory accessory)
        {
            if (id != accessory.Id)
            {
                return NotFound();
